...
#define XPT2046_PENIRQ_Read()                                                  \
  GPIO_ReadInputDataBit(XPT2046_PENIRQ_GPIO_PORT, XPT2046_PENIRQ_GPIO_PIN)
...
#define XPT2046_ERROR(fmt, arg...)                                             \
  printf("<<-XPT2046-ERROR->> " fmt "\n", ##arg)
